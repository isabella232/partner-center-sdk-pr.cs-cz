...
Následující metody můžete použít k získání podrobností kolekce pro položky řádku faktury (známé také jako řádky s uzavřenými fakturačními položkami) pro zadanou fakturu.
...
Toto rozhraní API podporuje také **poskytovatele služeb** **Azure** a **Office** for Microsoft Azure (MS-AZR-0145P) a nabídky pro Office, které zpřístupňuje funkci rozhraní API zpětně kompatibilní.
...
Následující syntaxe platí v případě, že je poskytovatel fakturace **Office**.
...
| fakturace – poskytovatel       | řetězec | Yes      | Zprostředkovatel fakturace: "Office", "Azure", "jednorázová".               |
