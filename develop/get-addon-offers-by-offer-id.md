...
**Ukázka**: [aplikace testů konzoly](console-test-app.md). **Project**: **třída** microsoft Partner SDK samples: getoffer. cs
...
| **krajin**  | **řetězec** | Y        | Kód země (například `US` ).       |
