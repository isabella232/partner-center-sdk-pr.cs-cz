...
<span data-ttu-id="9a0e5-123">Příklad naleznete v následujících tématech:</span><span class="sxs-lookup"><span data-stu-id="9a0e5-123">For an example, see the following:</span></span>
