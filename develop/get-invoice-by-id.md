...
|---------|-------------------------------------------------------------------------------|
| **Čtěte** | [*{baseURL}*](partner-center-rest-urls.md)/v1/Invoices/{Invoice-ID} HTTP/1.1 |
...
V případě úspěchu tato metoda vrátí prostředek [faktury](invoice-resources.md#invoice) v těle odpovědi.
