...
Následující příklad odpovědi se vrátí, pokud oblast nepřímých prodejců (PGA/PLA) neodpovídá oblasti nepřímého zprostředkovatele. [Přečtěte si další informace](/partner-center/regional-authorization-overview) o oblastech CSP.
...
Následující příklad odpovědi se vrátí, když účet nepřímý prodejce CSP v partnerském centru nepodepsal aktivaci. [Další informace](https://partner.microsoft.com/resources/detail/verify-mpa-acceptance-status-pptx)
...
Následující příklad odpovědi se vrátí, když partnerské Centrum dokáže rozpoznat ID MPN (PGA/PLA) předané v žádosti, ale k danému ID MPN (PGA/PLA) se nepřidruží žádný zápis CSP. [Další informace](https://partner.microsoft.com/resources/detail/onboard-pc-csp-mpn-mpa-guide-pptx)
...
Následující příklad odpovědi se vrátí, když Partnerská centra nemůže najít žádný signaturu technologie MPA s daným ID tenanta.
