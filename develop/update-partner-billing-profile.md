...
Pokud chcete aktualizovat fakturační profil partnera, načtěte si stávající profil. Jakmile profil aktualizujete, použijte svou kolekci **IAggregatePartner. Profiles** a zavolejte vlastnost **BillingProfile** . Nakonec zavolejte metodu **Update ()** .
...
**Ukázka**: [aplikace testů konzoly](console-test-app.md). **Project**: **třída** microsoft Partner SDK samples: UpdateBillingProfile. cs
